...
<section class="main">
  <div class="banner" id="main">
    <div class="floating-text">
      <h1><strong> I Congreso Caleidoscopio</strong></h1>
      <h2 class="shadow"> Una nueva proyeccion de las Relaciones Internacionales </h2>
      <div class="text">
        <p>
            Les enviamos a todos un cordial saludo a nombre de la Sociedad de Alumnos de la
            Licenciatura de Relaciones Internacionales (SALRI) del Tecnológico de Monterrey
            Campus Querétaro. <br>
            Es parte de nuestro objetivo crear espacios de aprendizaje que brinden
            a los estudiantes de la carrera oportunidades internacionales, experiencias de cooperación y
    ...
    <div class="heads-wrapper col-sm-5">
      ...
      <ul class="heads col-sm-3">
        <li style="background-image: url('/webroot/img/fotos/francisco_cossio.jpg');"></li>
            <span class="speaker-name"> Francisco González de Cossío </span>
      </ul>
    </div>
  </div>
...
<section class="map">
  <div class="container">
    ...
    <iframe src="https://mapsengine.google.com/map/u/0/embed?mid=zJXe-F8a2Z74.k-jV7WoTNrH0" width="100%" height="400"></iframe>
</section>
...
<section class="sponsors">
 <div class="container bind">
    <p class="col-sm-10 col-sm-offset-1">
        <img src="/webroot/img/logos/logo_azul.png"  alt="">
        <img src="/webroot/img/logos/lri.png"  alt="">
        <img src="/webroot/img/logos/salri.jpg"  alt="">
        <img src="/webroot/img/logos/grupos.jpg"  alt="">
    </p>
    <p class="col-sm-12">
        <img src="/webroot/img/logos/coca-cola.jpg"  alt="Coca-Cola">
        <img src="/webroot/img/logos/gob_qro.jpg"  alt="">
        <img src="/webroot/img/logos/qro.jpg"  alt="">
        <img src="/webroot/img/logos/soluciones.jpg"  alt="">
        <img src="/webroot/img/logos/valores.jpg"  alt="">
    </p>
 </div>
</section>
</div>
